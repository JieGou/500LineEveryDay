    ...
    class E1001Samples01
    {
        ...
        public static string RunSample1()
        {
...

            {
                ...
                worksheet1.Cells["A2"].Value = 12002;
                worksheet1.Cells["B2"].Value = "Hammer";
                worksheet1.Cells["C2"].Value = 5;
                worksheet1.Cells["D2"].Value = 12;

                worksheet1.Cells["A2"].Value = 12003;
                worksheet1.Cells["B2"].Value = "Saw";
                worksheet1.Cells["C2"].Value = 10;
                worksheet1.Cells["D2"].Value = 100;
                ...
                package.Workbook.Properties.Comments = "this sample demonstrates how to " +
                                                       "creat an Excel 2007 workbook using EPPlus";

                //设置一些扩展属性值
                package.Workbook.Properties.Company = "AdventurWorks Inc";

                //设置一些custom 属性值
                package.Workbook.Properties.SetCustomPropertyValue("checked by", "老往");
                package.Workbook.Properties.SetCustomPropertyValue("AssemblyName", "EPPlus");

                var xlFile = Utils.GetFileInfo("sample01.xlsx");
