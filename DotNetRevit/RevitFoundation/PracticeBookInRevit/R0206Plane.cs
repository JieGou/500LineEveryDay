...
{
    /// <summary>
    /// 延时revit 的Angleto 方法和 arc.create方法 ,角度的认定关系.
    /// </summary>
    ...
    public class R0206Plane : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            XYZ pnt1 = new XYZ(1, 0, 0);
            XYZ pnt2 = new XYZ(0, 1, 0);
            XYZ pnt3 = new XYZ(-1, 1, 0);
            XYZ pnt4 = new XYZ(-1, -1, 0);
            Line line1 = Line.CreateBound(XYZ.Zero, pnt1);
            Line line2 = Line.CreateBound(XYZ.Zero, pnt2);
            Line line3 = Line.CreateBound(XYZ.Zero, pnt3);
            ...
            double startAngle = line1.Direction.AngleTo(line2.Direction);
            LDir1 += "\nstartAngle :" + startAngle;

            double endAngle = line1.Direction.AngleTo(line3.Direction);
            LDir1 += "\nendAngle:" + endAngle;

            TaskDialog.Show("tips:", LDir1);

            XYZ xAxis = new XYZ(1, 0, 0);
            XYZ yAxis = new XYZ(0, 1, 0);
            Curve curve1 = Arc.Create(XYZ.Zero, 10, startAngle+Math.PI, endAngle+Math.PI, xAxis, yAxis);
            ...
            ModelCurve modelCurve = doc.FamilyCreate.NewModelCurve(curve1, sketchPlane);
...
public class TrussA80
{
        ...
        XYZ BoundPnt2, XYZ BoundPnt3, XYZ InterPnt1, XYZ InterPnt2, XYZ InterPnt3, XYZ InterPnt4)
    {
        ...
        //利用轮廓和路径创建放样
        // Sweep sweep1 =doc.FamilyCreate.NewSweep(true, curvePath, sketchPlane, profile, 0, ProfilePlaneLocation.End);
