...
namespace CodeInTangsengjiewa.建筑
{
    /// <summary>
    /// 一键成板
    /// </summary>
    ...
    class Cmd_CreateFloorQuickly : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var targetFloortype = selectorUI.floortypeBox.SelectionBoxItem as FloorType; //目标楼板类型
            ...
            var edgeArraya = upfaces.First().EdgeLoops.Cast<EdgeArray>().ToList();
    ...
    public static class TemUtils
    {
        ...
        public static List<Face> GetuFaces(this GeometryObject geoele)
        {
