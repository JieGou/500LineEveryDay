...
//             ts.Start();
//
//             TrussR80 trussR80 = new TrussR80(doc, 400);
//
//             ts.Commit();
//
...
//     }
//
//     public class TrussR80
//     {
//         private double _length;
//         public double Length { set; get; }
//
//         public double UpSteelDiameter
//         {
//             get;
//             set;
//         } = mmToFeet(8);
//
//
//         public static double BraceSteelDiameter
//         {
//             get;
//             set;
//         } = mmToFeet(4);
//
//         public static double TrussBraceTotalHeight
//         {
//             get;
//             set;
//         } = mmToFeet(85);
//
//         public static double TrussBraceSteelHeight2
//         {
//             get;
//             set;
//         } = TrussBraceTotalHeight - BraceSteelDiameter;
//
//
...
//
//             CurveArray tempCurveArray = CreatePeriodCurve(ref curvesPath);
//
//             center1 = new XYZ(center1.X + mmToFeet(200), center1.Y, center1.Z);
//             center1 = new XYZ(center1.X + mmToFeet(200), center1.Y, center1.Z);
//             center1 = new XYZ(center1.X + mmToFeet(200), center1.Y, center1.Z);
//
//             BoundPnt1 = new XYZ(BoundPnt1.X + mmToFeet(200), BoundPnt1.Y, BoundPnt1.Z);
//             BoundPnt2 = new XYZ(BoundPnt2.X + mmToFeet(200), BoundPnt2.Y, BoundPnt2.Z);
//             BoundPnt3 = new XYZ(BoundPnt3.X + mmToFeet(200), BoundPnt3.Y, BoundPnt3.Z);
//
//             InterPnt1 = new XYZ(InterPnt1.X + mmToFeet(200), InterPnt1.Y, InterPnt1.Z);
//             InterPnt2 = new XYZ(InterPnt2.X + mmToFeet(200), InterPnt2.Y, InterPnt2.Z);
//             InterPnt3 = new XYZ(InterPnt3.X + mmToFeet(200), InterPnt3.Y, InterPnt3.Z);
//             InterPnt4 = new XYZ(InterPnt4.X + mmToFeet(200), InterPnt4.Y, InterPnt4.Z);
//
...
//         }
//
//         private CurveArray CreatePeriodCurve(ref CurveArray curvesArray)
//         {
//             Curve curve1 = CreateArc1(InterPnt1.X);
//             curvesArray.Append(curve1);
//
//             Line line1 = CreateLine1(InterPnt2.X, InterPnt1, InterPnt2);
//             curvesArray.Append(line1);
//
//             Curve curve2 = CreateArc2(InterPnt3.X, BoundPnt2, center2);
//             curvesArray.Append(curve2);
//
//             Line line2 = CreateLine1(InterPnt4.X, InterPnt3, InterPnt4);
//             curvesArray.Append(line2);
//
//             Curve curve3 = CreateArc3(BoundPnt3.X, BoundPnt3, center3);
//             curvesArray.Append(curve3);
//
//             return curvesArray;
//         }
//
