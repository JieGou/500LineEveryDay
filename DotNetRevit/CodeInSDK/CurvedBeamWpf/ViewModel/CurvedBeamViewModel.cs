...
namespace CurvedBeamWpf.ViewModel
{
    ...
    public class CurvedBeamViewModel : NotificationObject
    {
        ...
        private void StartCreateBeamArcCommand(object parameter)
        {

            string info = LevelType.Name + "\n";
        ...
        public CurvedBeamViewModel(ExternalCommandData commandData)
        {
            ...
            StartCreateCommand.ExecuteAction = new Action<object>(StartCreateBeamArcCommand);
